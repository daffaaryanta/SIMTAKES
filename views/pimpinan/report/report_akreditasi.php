...
if (isset($_POST['excel'])) {
    ...
    if ($cetak == 1) {
        ...
        echo "<script>
                ...
                document.location.href = '../../excel/excel_arumahsakit.php';
            </script>";
    } elseif ($cetak == 2) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_apuskesmas.php';
            </script>";
    } elseif ($cetak == 3) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_aklinik.php';
            </script>";
    } elseif ($cetak == 4) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_alabkes.php';
            </script>";
    } elseif ($cetak == 5) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_apmdu.php';
            </script>";
    } elseif ($cetak == 6) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_apmsp.php';
            </script>";
    } elseif ($cetak == 7) {
        
        echo "<script>
                
                document.location.href = '../../excel/excel_atransfusi.php';
            </script>";
    } 
    else{
        echo "<script>
