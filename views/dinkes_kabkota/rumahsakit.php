...
$rumahsakit = query("SELECT * FROM mahasiswa ORDER BY nim DESC");
?>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= date('d-m-Y H:i:s', strtotime($hukum->waktu_input)); ?></td>
                                            <td>
                                            <a href="<?= base_url('con_hukum/ubah/' . $hukum->id_responden) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a><br>
                                            <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('con_hukum/hapus/' . $hukum->id_responden) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
                                    </tbody>
