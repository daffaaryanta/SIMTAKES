                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        if ($id_role == '2') {
                            echo '
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <a href="aktivitas-tambah.php" class="btn btn-primary btn-icon-split">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-dark" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                <td><img src='../../../img/<?php echo $aktivitas['dokumentasi'];?>' width='auto' height='200px' >
                                            
                                                <hr><a href='../../../img/<?php echo $aktivitas['dokumentasi'];?>' target="_blank">Lihat Foto</a></td>
                                                ...
                                                <div class="container text-center">
                                                   ...
                                                   ?>
                                                    <a href="aktivitas-edit.php?id_aktivitas=<?= $aktivitas['id_aktivitas']; ?>"class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
                                                    <a  href="hapusaktivitas.php?id_aktivitas=<?= $aktivitas['id_aktivitas']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data Aktivitas <?= $aktivitas['nama']; ?> ?');"><i class="fa fa-trash"></i></a> <?php }?> </td>
                                                </div>
                                            </tr>
                                            <?php endforeach ?>
                                        </tbody>
